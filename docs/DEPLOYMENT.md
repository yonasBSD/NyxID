...
docker tag nyxid-backend registry.example.com/nyxid/backend:v0.3.0
docker tag nyxid-frontend registry.example.com/nyxid/frontend:v0.3.0

docker push registry.example.com/nyxid/backend:v0.3.0
docker push registry.example.com/nyxid/frontend:v0.3.0
```
...
```yaml
image: registry.example.com/nyxid/backend:v0.3.0  # replace
image: registry.example.com/nyxid/frontend:v0.3.0  # replace
```
