import { ensureBaseToken, ensureDelegatedToken, exchangeAuthorizationCode, getProxyCredentialProfile, listServices, proxyRequest, } from "./client.js";
import { buildAuthorizeUrl, createOpaqueState, createPkcePair, loadProfile, normalizeConfig, requireOAuthClient, saveProfile, } from "./helpers.js";
    ...
    if (registerProvider) {
        registerProvider({
            ...
            authorize: async ({ redirectUri, state, scope }) => {
                const config = normalizeConfig(globalThis.OPENCLAW_NYXID_CONFIG);
