...
type ChartTooltipContentProps = {
  ...
  formatter?: (value: ValueType | undefined, name: NameType | undefined, item: Payload<ValueType, NameType>, index: number, payload: ReadonlyArray<Payload<ValueType, NameType>>) => React.ReactNode | [React.ReactNode, NameType]
