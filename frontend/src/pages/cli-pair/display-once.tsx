...
// copy-to-clipboard affordance, blurs the secret until the user clicks
// "Reveal", and owns the "I saved it" → complete-pairing button.
//
// All four pairing flows finish here; only the label text and the
// shape of the ack-payload callback differ per kind.
...
export function DisplayOncePanel({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {secondarySecret ? (
        <SecretField
          label={secondarySecret.label}
          value={secondarySecret.value}
        />
      ) : null}
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-muted-foreground">
          This value will not be shown again. Confirm you have saved it
